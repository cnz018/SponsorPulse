...
public class StaticReportRepository
{
    ...
    /// </summary>
    public static TwitterAnalytics GetSponsorPulseReport() => new()
    {
        TotalTweets = 2847,
    ...
    /// </summary>
    public static TwitterAnalytics GetValorantChampionsReport() => new()
    {
        TotalTweets = 5234,
    ...
    /// </summary>
    public static Dictionary<string, TwitterAnalytics> GetAllReports() => new()
    {
